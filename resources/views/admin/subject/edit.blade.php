                        ...
                        <div class="x_content">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4 col-sm-4  form-group has-feedback">
                                    <input type="text" value="{{ $getSingle->subject_name }}"
...
@enderror">
                                        <option {{( $getSingle->subject_type == 'Theory') ? 'selected' : ''}} value="Theory">Theory</option>
                                        <option {{( $getSingle->subject_type == 'Pratical') ? 'selected' : ''}} value="Pratical">Pratical</option>
