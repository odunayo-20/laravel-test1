									...
									<form action="" method="POST">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="name" value="{{ $getSingle->name }}" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name" name="email" class="form-control" value="{{ $getSingle->email }}">
											</div>
										</div>
